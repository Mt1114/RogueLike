...
def main():
    ...
    pygame.display.set_caption("光照位置测试")
    ...
    while running:
        ...
        screen.blit(ninja_pos, (10, screen_height - 60))
        screen.blit(mystic_pos, (10, screen_height - 35))
        
        # 显示相机位置
        camera_pos = font.render(f"相机: ({game.camera_x:.0f}, {game.camera_y:.0f})", True, (255, 255, 0))
        screen.blit(camera_pos, (10, screen_height - 85))
        
        # 显示屏幕中心位置
        screen_center = font.render(f"屏幕中心: ({screen_width//2}, {screen_height//2})", True, (255, 255, 255))
        screen.blit(screen_center, (10, screen_height - 110))
