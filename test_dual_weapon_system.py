...
def test_dual_weapon_system():
    """测试双武器系统"""
    pygame.init()
    screen = pygame.display.set_mode((1200, 800))
    pygame.display.set_caption("双武器系统测试")
    ...
    while running:
        ...
        for i, text in enumerate(weapon_info):
            ...
            screen.blit(text_surface, (10, 300 + i * 25))
